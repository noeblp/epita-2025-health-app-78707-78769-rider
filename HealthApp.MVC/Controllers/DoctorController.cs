...
public class DoctorController : Controller
{
    ...
    public IActionResult HomeDoctor(int? year, int? month, int? week)
    {
        ...
        {
            res =GetPatientEvents2(connection,userId);
        }
    ...
    static List<string> GetPatientEvents2(SqliteConnection connection, int? patientId)
    {
